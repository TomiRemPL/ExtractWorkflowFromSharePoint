...
flowchart TD
  start((Start))
  n1["Start workflow 'NWF004'. Uruchamiane: ręcznie."]
  start --> n1
  ...
  n3 --> n4
  n5["Oblicz datę:  (-1 dni) -> zapisz do zmiennej ."]
  n4 --> n5
  n6["Ustaw zmienną: Zapisz w zmiennej 'zm_MiesiącSprawozdawczy_t…"]
  n5 --> n6
  n7["Zapisz wpis w historii przepływu: „Data rozpoczęcia: {Workf…"]
  n6 --> n7
  n8["Ustalenie zmiennej: Zapisz w zmiennej 'zm_KodPozycji_H1_txt…"]
  n7 --> n8
  n9["Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H2_txt' war…"]
  n8 --> n9
  n10["Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H3_txt' war…"]
  n9 --> n10
  n11["Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H4_txt' war…"]
  n10 --> n11
  n12["Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H5_txt' war…"]
  n11 --> n12
  n13["Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H6_txt' war…"]
  n12 --> n13
  n14["Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg waru…"]
  n13 --> n14
  ...
  n18 --> n19
  n20["Zapisz wpis w historii przepływu: „Kod poz. H1: {WorkflowVa…"]
  n19 --> n20
  ...
  n49 --> n50
  n51["Wyślij powiadomienie e-mail: temat 'SIZ IT: Informacja o te…"]
  n50 --> n51
  stop((Koniec))
  n51 --> stop
```
...
- `[n1]` Start workflow 'NWF004'. Uruchamiane: ręcznie.
  ...
  ChangeComments = 
  Id = {7EF71A10-D4BF-4C59-BE8D-D3131AA17C6E}
...
- `[n3]` Etap biznesowy: Etap 1: Ustalenie zmiennych.
  ...
  ```
    ...
    - `[n6]` Ustaw zmienną: Zapisz w zmiennej 'zm_MiesiącSprawozdawczy_txt' wartość: fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data}, "MM").
    ...
    - `[n7]` Zapisz wpis w historii przepływu: „Data rozpoczęcia: {WorkflowVariable:zm_DataRozpoczęcia_data}” (…)
...
Miesiąc sprawozdawczy: {WorkflowVariable:zm_MiesiącSprawozdawczy_txt}
      ```
        ...
        - `[n8]` Ustalenie zmiennej: Zapisz w zmiennej 'zm_KodPozycji_H1_txt' wartość: H1-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"yyyy")-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"MM").
        ...
        - `[n9]` Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H2_txt' wartość: H2-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"yyyy")-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"MM").
        ...
        - `[n10]` Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H3_txt' wartość: H3-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"yyyy")-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"MM").
        ...
        - `[n11]` Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H4_txt' wartość: H4-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"yyyy")-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"MM").
        ...
        - `[n12]` Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H5_txt' wartość: H5-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"yyyy")-fn-FormatDate({WorkflowVariable:zm_DataSprawozdawcza_data},"MM").
        ...
        - `[n13]` Ustaw zmienną: Zapisz w zmiennej 'zm_KodPozycji_H6_txt' wartość: H6-fn-FormatDate(zm_DataSprawozdawcza_data,"yyyy")-fn-FormatDate(zm_DataSprawozdawcza_data,"MM").
          > **Wskazówka migracji**: Obliczenie/odczyt i zapis do zmiennej lokalnej 'zm_KodPozycji_H6_txt'.
          ```plsql
          l_zm_kodpozycji_h6_txt := 'H6-fn-FormatDate(zm_DataSprawozdawcza_data,"yyyy")-fn-FormatDate(zm_DataSprawozdawcza_data,"MM")';
          ```
          <details><summary>Szczegóły techniczne</summary>
          ...
          ValueType = Text
          VariableName = 
          Value = H6-fn-FormatDate(zm_DataSprawozdawcza_data,"yyyy")-fn-FormatDate(zm_DataSprawozdawcza_data,"MM")
          ```
          </details>
        - `[n14]` Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg warunku: Kod_x0020_sprawozdawczy jest równe '{WorkflowVariable:zm_KodPozycji_H1_txt}'.
        ...
        - `[n15]` Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg warunku: Kod_x0020_sprawozdawczy jest równe '{WorkflowVariable:zm_KodPozycji_H2_txt}'.
        ...
        - `[n16]` Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg warunku: Kod_x0020_sprawozdawczy jest równe '{WorkflowVariable:zm_KodPozycji_H3_txt}'.
        ...
        - `[n17]` Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg warunku: Kod_x0020_sprawozdawczy jest równe '{WorkflowVariable:zm_KodPozycji_H4_txt}'.
        ...
        - `[n18]` Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg warunku: Kod_x0020_sprawozdawczy jest równe '{WorkflowVariable:zm_KodPozycji_H5_txt}'.
        ...
        - `[n19]` Wyszukaj elementy na liście 'INF006 - Harmonogramy' wg warunku: Kod_x0020_sprawozdawczy jest równe '{WorkflowVariable:zm_KodPozycji_H6_txt}'.
    ...
    - `[n20]` Zapisz wpis w historii przepływu: „Kod poz. H1: {WorkflowVariable:zm_KodPozycji_H1_txt} / Pl. data dostawy H1: {WorkflowVariable:zm_PlanDataDostawy_H1_data}” (…)
      > **Wskazówka migracji**: Zapis audytowy do dziennika zdarzeń (Audit Log).
      ```plsql
      apex_debug.info('Workflow: ' || 'Kod poz. H1: ' || l_zm_kodpozycji_h1_txt || ' / Pl. data dostawy H1: ' || l_zm_plandatadostawy_h1_data || '
      Kod poz. H2: ' || l_zm_kodpozycji_h2_txt || ' / Pl.  data dostawy H2: ' || l_zm_plandatadostawy_h2_data || '
      Kod poz. H3: ' || l_zm_kodpozycji_h3_txt || ' / Pl.  data dostawy H3: ' || l_zm_plandatadostawy_h3_data || '
      Kod poz. H4: ' || l_zm_kodpozycji_h4_txt || ' / Pl.  data dostawy H4: ' || l_zm_plandatadostawy_h4_data || '
      Kod poz. H5: ' || l_zm_kodpozycji_h5_txt || ' / Pl.  data dostawy H5: ' || l_zm_plandatadostawy_h5_data || '
      Kod poz. H6: ' || l_zm_kodpozycji_h6_txt || ' / Pl.  data dostawy H6: ' || l_zm_plandatadostawy_h6_data);
      ```
      <details><summary>Szczegóły techniczne</summary>

      ```
      Message = Kod poz. H1: {WorkflowVariable:zm_KodPozycji_H1_txt} / Pl. data dostawy H1: {WorkflowVariable:zm_PlanDataDostawy_H1_data}
Kod poz. H2: {WorkflowVariable:zm_KodPozycji_H2_txt} / Pl.  data dostawy H2: {WorkflowVariable:zm_PlanDataDostawy_H2_data}
Kod poz. H3: {WorkflowVariable:zm_KodPozycji_H3_txt} / Pl.  data dostawy H3: {WorkflowVariable:zm_PlanDataDostawy_H3_data}
Kod poz. H4: {WorkflowVariable:zm_KodPozycji_H4_txt} / Pl.  data dostawy H4: {WorkflowVariable:zm_PlanDataDostawy_H4_data}
Kod poz. H5: {WorkflowVariable:zm_KodPozycji_H5_txt} / Pl.  data dostawy H5: {WorkflowVariable:zm_PlanDataDostawy_H5_data}
Kod poz. H6: {WorkflowVariable:zm_KodPozycji_H6_txt} / Pl.  data dostawy H6: {WorkflowVariable:zm_PlanDataDostawy_H6_data}
      ```
      </details>
- `[n21]` Etap biznesowy: INF002 Rejestr Raportów.
...
- `[n49]` Etap biznesowy: Mail.
  ...
  -- =========================================
  ```
    - `[n50]` Zbuduj ciąg tekstowy i przypisz do zmiennej (brak). Wartość: {WorkflowVariable:zm_SIZCOM1_not}
<html>
...
<html>
 ...
 <tbody>
    ...
    - `[n51]` Wyślij powiadomienie e-mail: temat 'SIZ IT: Informacja o terminie dostarczenia raportów i danych' do: grupa\rdudziak.
...
| `zm_DataSprawozdawcza_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
...
| `zm_PlanDataDostawy_H1_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
| `zm_PlanDataDostawy_H2_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
| `zm_PlanDataDostawy_H3_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
| `zm_PlanDataDostawy_H4_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
| `zm_PlanDataDostawy_H5_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
| `zm_PlanDataDostawy_H6_data` | Text | Używana w wyrażeniach warunkowych/komunikatach |
...
```plsql
CREATE OR REPLACE PROCEDURE process_wf_nwf004 (
    p_item_id IN NUMBER
) AS
    ...
    l_zm_plandatadostawy_h1_data   VARCHAR2(4000);
    l_zm_plandatadostawy_h2_data   VARCHAR2(4000);
    l_zm_plandatadostawy_h3_data   VARCHAR2(4000);
    l_zm_plandatadostawy_h4_data   VARCHAR2(4000);
    l_zm_plandatadostawy_h5_data   VARCHAR2(4000);
    l_zm_plandatadostawy_h6_data   VARCHAR2(4000);
    l_zm_sizcom1_not               VARCHAR2(4000);
    l_zm_symbol_txt                VARCHAR2(4000);
    l_zm_tre_01_not                VARCHAR2(4000);
BEGIN
    apex_debug.info('Start workflow: NWF004, item_id: ' || p_item_id);
    ...
    apex_debug.info('Koniec workflow: NWF004, item_id: ' || p_item_id);
END process_wf_nwf004;
/
```
